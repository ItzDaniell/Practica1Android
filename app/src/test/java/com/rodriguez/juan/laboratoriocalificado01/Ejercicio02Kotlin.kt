...
class Ejercicio02Kotlin(){
    ...
    @Test
    fun main(){
        val result = VowelCount("Juan") /* Se llama a la función VowelCount de 1 parametro de texto y el resultado se guarda en la variable result */
    ...
    private fun VowelCount(text1: String):Int {
        ...
        for (char in arrayText1) if (char in vowels) ++count /* Se inicia un bucle para que un caracter recorra el array de caracteres, si el caracter es una vocal, incrementa el contador */
